...
{//verif si donne sont bien saisies
	...
	{//rechercher si donnees saisie existe deja
		...
		{//insertion donnees dans table informations
	...
	<div class="container">	
		...
		<div class="frm">
			...
			<form method="POST" action="#">
				...
				<label>Telephone :<span>*</span></label><input type="text" name="tele" maxlength="10" placeholder="Par exemple : 20485768"><img style="top: 40.3%" src="phone.png"><br>
				...
				<label>Ville :<span>*</span></label><select name="ville">
														<option >Mahdia</option><option >Sousse</option><option >Sfax</option>
														<option >Tunis</option><option >Ariana</option><option >Monastir</option>
														<option >Médenine</option><option >Nabeul</option><option >Zaghouan</option>
														<option >Bizerte</option><option >La Manouba</option></select><br>
				...
				<label style="margin-top: 85px">Prix :<span>*</span></label><input type="text" name="prix" placeholder="prix en Dinars" style="width: 25%;margin-right: 46.5%"><br>		
